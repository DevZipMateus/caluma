...
const SubcategoryProducts: React.FC<SubcategoryProductsProps> = ({
  ...
  return <div className="w-full mb-4 sm:mb-6 animate-fade-in">
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="p-3 sm:p-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            return <Card key={product.id} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                  <CardContent className="p-0">
                    ...
                    <div className="p-3 space-y-3">
                      ...
                      {!isSelected && <Button onClick={() => handleSelectProduct(product)} size="sm" className="w-full bg-gray-950 hover:bg-gray-800">
                          <ShoppingCart size={14} className="mr-2" />
                          Selecionar Produto
                        </Button>}

                      {/* Quantity Controls - Show when selected */}
                      {isSelected && <div className="space-y-2">
                          {/* Selected Status */}
                          ...
                          if (quantity === 1) {
                            ...
                            updateQuantity(product.id, quantity - 1);
                              ...
                              <Button size="sm" variant="outline" className="h-7 w-7 p-0" onClick={() => updateQuantity(product.id, quantity + 1)}>
                                <Plus size={12} />
                              </Button>
                            </div>
                          </div>
