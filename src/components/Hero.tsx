...
const Hero = () => {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-primary to-primary/80 overflow-hidden pt-14 sm:pt-16 md:pt-18 lg:pt-20">
      {/* Background Pattern */}
        ...
        <div className="max-w-full mx-auto">
          ...
          <div className="animate-fade-in">
            <img 
              ...
              className="h-[70vh] sm:h-[75vh] md:h-[80vh] lg:h-[90vh] xl:h-[95vh] 2xl:h-[98vh] w-auto mx-auto drop-shadow-2xl max-w-full"
            />
          </div>
        </div>
      </div>
