...
interface ProductSelectionContextType {
  ...
  productsInSelection: ProductInSelection[];
  selectProduct: (product: Omit<ProductInSelection, 'quantity'>) => void;
  addProductDirectly: (product: Omit<SelectedProduct, 'quantity'>) => void;
  updateSelectionQuantity: (productId: number, newQuantity: number) => void;
  removeFromSelection: (productId: number) => void;
  addToCart: (productId: number) => void;
  addProduct: (product: SelectedProduct) => void;
  removeProduct: (productId: number) => void;
  updateQuantity: (productId: number, newQuantity: number) => void;
  getProductInSelection: (productId: number) => ProductInSelection | undefined;
  getProductInCart: (productId: number) => SelectedProduct | undefined;
}
